<section class="section_filter_primero section_filtros relative w-full flex flex-col items-center">
    <div class="w-full lg:w-9/12">
        <h4 class="font-avant text-2xl color-pink text-center lg:text-start">Cuarto Primaria</h4>
        <div class="flex items-center justify-center lg:justify-start">
            <p class="font-avant text-base">Lectura para estudiantes de</p>
            <img class="" src="<?php echo get_template_directory_uri(  ) ?>/assets/recursos_digitales/diez.png" alt="Portada del libro">
        </div>
    </div>
    <swiper-container class="swiperCuarto w-full lg:w-9/12 mt-6"  space-between="10"
    ...
    <div class="swiper-button-prev swiperCuarto-prev"></div>
    <div class="swiper-button-next swiperCuarto-next"></div>
...
<script>
const swiperCuarto = document.querySelector('.swiperCuarto');
Object.assign(swiperCuarto, {
    slidesPerView: 1,
    spaceBetween: 5,
    navigation: {
        nextEl: '.swiperCuarto-next', // Clase específica para "Next"
        prevEl: '.swiperCuarto-prev', // Clase específica para "Prev"
    },
    breakpoints: {
        "@0.00": {
            slidesPerView: 1,
