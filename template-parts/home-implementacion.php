...
<div class="container flex flex-col items-center mb-20 md:mb-40 xl:mb-56 mt-12 lg:mt-0">
        <div class="flex flex-col items-center">
            ...
            <div class="w-full flex flex-col items-center xl:items-start relative">

                <div class="card-implementacion">
                    <div class="title">
                        Diagnóstico lector
                    </div>
                    <div class="content my-3">
                        El docente podrá asignar las pruebas diagnósticas de inicio y de cierre a su plan lector.
                    </div>
                </div>

                <div class="card-implementacion">
                    <div class="title">
                    Dosificación lectora
                    </div>
                    <div class="content my-3">
                        <ul class="list-decimal ms-4">
                            <li>
                                Lectura de enriquecimiento integral: Obras impresas 
                            </li>
                            <li>
                                Lectura por placer. Biblioteca Virtual
                            </li>
                        </ul>
                    </div>
                </div>
