<section class="section_filter_primero section_filtros relative w-full flex flex-col items-center">
    <div class="w-full lg:w-9/12">
        <h4 class="font-avant text-2xl color-red text-center lg:text-start">Tercero Primaria</h4>
        <div class="flex items-center justify-center lg:justify-start">
            <p class="font-avant text-base">Lectura para estudiantes de</p>
            <img class="" src="<?php echo get_template_directory_uri(  ) ?>/assets/recursos_digitales/nueve.png" alt="Años">
        </div>
    </div>
    <swiper-container class="swiperTercero w-full lg:w-9/12 mt-6"  space-between="10"
    ...
    <div class="swiper-button-prev swiperTercero-prev"></div>
    <div class="swiper-button-next swiperTercero-next"></div>
...
<script>
const swiperTercero = document.querySelector('.swiperTercero');
Object.assign(swiperTercero, {
    slidesPerView: 1,
    spaceBetween: 5,
    navigation: {
        nextEl: '.swiperTercero-next', // Clase específica para "Next"
        prevEl: '.swiperTercero-prev', // Clase específica para "Prev"
    },
    breakpoints: {
        "@0.00": {
            slidesPerView: 1,
